...
template <
    ...
    index_t NumSeqgments                                                 = 1,
    class GemmABlockCopyThreadSegmentLengths_GemmG_GemmK_GemmM_GemmKPack = Sequence<1, 1, 1, 1>,
    class GemmBBlockCopyThreadSegmentLengths_GemmG_GemmK_GemmN_GemmKPack = Sequence<1, 1, 1, 1>>
