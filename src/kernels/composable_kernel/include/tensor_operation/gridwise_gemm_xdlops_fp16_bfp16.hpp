...
struct GridwiseGemmTransposedANormalBNormalCXdlopsFp16Bfp16_v1
{
                        ...
                        CFloat* const __restrict__ p_c_global) const
    {
        ...
        auto a_blockwise_copy = BlockwiseGenericTensorSliceCopy_v4<
            ...
            NumSegments,
            Sequence<2, 2>,
            Sequence<1, 2, 1>>({0, k_block_data_on_global, 0}, {0, 0, 0});
        ...
        auto b_blockwise_copy = BlockwiseGenericTensorSliceCopy_v4<
            ...
            NumSegments,
            Sequence<2, 2>,
            Sequence<2, 1, 1>>({0, b_block_data_on_global, 0}, {0, 0, 0});
...
struct GridwiseBatchedGemmTransposedANormalBNormalCXdlopsFp16Bfp16_v1
{
                        ...
                        CFloat* const __restrict__ p_c_global) const
    {
        ...
        auto a_blockwise_copy = BlockwiseGenericTensorSliceCopy_v4<
            ...
            NumSegments,
            Sequence<2, 2>,
            Sequence<1, 1, 2, 1>>({group_id, 0, m_block_data_on_global, 0}, {0, 0, 0, 0});
        ...
        auto b_blockwise_copy = BlockwiseGenericTensorSliceCopy_v4<
            ...
            NumSegments,
            Sequence<2, 2>,
            Sequence<1, 2, 1, 1>>({group_id, 0, n_block_data_on_global, 0}, {0, 0, 0, 0});
